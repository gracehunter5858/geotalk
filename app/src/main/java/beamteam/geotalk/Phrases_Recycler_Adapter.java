...
public class Phrases_Recycler_Adapter extends RecyclerView.Adapter<Phrases_Recycler_Adapter.ViewHolder>{
    private static final String TAG = "PhrRecAdapt";
    private String[] phrases;
    private Context mContext;

    public Phrases_Recycler_Adapter(String[] phrases, Context mContext) {
